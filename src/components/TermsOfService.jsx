...
const TermsOfService = () => {
  return (
    <div className="legal-container">
      ...
      <section className="section">
        <h2>5. Account Creation and Security</h2>
        <p>
      ...
      <section className="section">
        ...
        <div>
          <div>Some features of our Platform may require payment. By subscribing, you agree to pay all applicable fees as described for your selected plan.</div><br></br>
          <div>Payments are processed securely through third-party payment processors.</div><br></br>
          <div>You authorize us to charge your payment method for recurring subscription fees until you cancel.</div><br></br>
        </div>
      </section>
